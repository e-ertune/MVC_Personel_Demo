...
namespace MVC_Personel.Controllers
{
    public class PositionsController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("ID,Name,Authority")] Position position)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Authority")] Position position)
        {
            if (id != position.ID)
            {
                return NotFound();
